...
if __name__ == '__main__':
    ...
    if True:
        coord_df2_occprime = macrostate_labels(superdf)
        ...
        for traj in superdf["TrajNum"].unique():
            ...
            coord_subset = superdf[superdf["TrajNum"]==traj]
